...
public sealed class AlarmsApi : IAlarmsApi
{
    ...
    /// <inheritdoc />
    public async Task<System.IO.Stream> UpdateAlarms<TAlarm>(TAlarm body, string? xCumulocityProcessingMode = null, System.DateTime? createdFrom = null, System.DateTime? createdTo = null, System.DateTime? dateFrom = null, System.DateTime? dateTo = null, bool? resolved = null, IReadOnlyList<string>? severity = null, string? source = null, IReadOnlyList<string>? status = null, bool? withSourceAssets = null, bool? withSourceDevices = null, CancellationToken cToken = default) where TAlarm : Alarm
    {
    ...
    /// <inheritdoc />
    public async Task<System.IO.Stream> DeleteAlarms(string? xCumulocityProcessingMode = null, System.DateTime? createdFrom = null, System.DateTime? createdTo = null, System.DateTime? dateFrom = null, System.DateTime? dateTo = null, bool? resolved = null, IReadOnlyList<string>? severity = null, string? source = null, IReadOnlyList<string>? status = null, IReadOnlyList<string>? type = null, bool? withSourceAssets = null, bool? withSourceDevices = null, CancellationToken cToken = default) 
    {
        const string resourcePath = "/alarm/alarms";
        var uriBuilder = new UriBuilder(new Uri(_httpClient.BaseAddress ?? new Uri(resourcePath), resourcePath));
        var queryString = HttpUtility.ParseQueryString(uriBuilder.Query);
    ...
    /// <inheritdoc />
    public async Task<int> GetNumberOfAlarms(System.DateTime? dateFrom = null, System.DateTime? dateTo = null, bool? resolved = null, IReadOnlyList<string>? severity = null, string? source = null, IReadOnlyList<string>? status = null, IReadOnlyList<string>? type = null, bool? withSourceAssets = null, bool? withSourceDevices = null, CancellationToken cToken = default) 
    {
